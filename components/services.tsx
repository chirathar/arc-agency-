...
const services = [
  ...
  },
  {
    ...
    description:
      "Data-driven campaigns that deliver real results and maximize your ROI across multiple platforms.",
  ...
  },
  {
    ...
    description:
      "Create seamless mobile experiences that engage users and drive conversions on any device.",
    color: "from-indigo-500 to-blue-600",
    link: "/services/mobile-experiences",
  },
]
                ...
                >
                  ...
                  <Card className="border-0 relative bg-white dark:bg-slate-800 overflow-hidden h-full transform transition-all duration-300 group-hover:translate-y-1 group-hover:shadow-xl">
                    ...
                    <CardHeader className="pt-6 pb-2">
                      ...
                      <CardTitle className="text-xl text-slate-800 dark:text-slate-100 mb-2">
                        {service.title}
                      </CardTitle>
